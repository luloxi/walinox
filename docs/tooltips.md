...
| Dónde | Texto |
| --- | --- |
| Billetera / saldo | El saldo se muestra en pesos al dólar blue. En localhost es de prueba. El asiento on-chain es USDT. |
...
| Página de tienda | Lugar del local, o: Catálogo de este local. Pagás en USDT; el precio se ve en pesos. |

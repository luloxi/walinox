...
- **Pears** — invite 8 chars + topic 32 bytes en cada permiso offline (QR, copy, file, NFC, air). Compatible tamaño Hyperswarm; el transporte sigue siendo el canal local.
